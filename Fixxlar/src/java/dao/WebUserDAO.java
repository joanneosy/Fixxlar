...
public class WebUserDAO {
    ...
    public WebUser authenticateUser(String email, String password) throws UnsupportedEncodingException, IOException {
        ...
        if (isSuccess.getAsString().equals("false")) {
            ...
            webUser = new WebUser(staffId, email, userType, refStaffId, token, shopId, name, handphone);
        }
        return webUser;
    }
    ...
    public boolean updateMasterWorkshopStaff(int staffId, String token, String name, String email, String handphone, int id) throws UnsupportedEncodingException, IOException {
    ...
    public boolean updateNormalWorkshopStaff(int staffId, String token, String name, String email, String handphone, int id) throws UnsupportedEncodingException, IOException {
    ...
    public boolean updateMasterAdmin(int staffId, String token, String name, String email, String handphone, int id) throws UnsupportedEncodingException, IOException {
    ...
    public boolean updateNormalAdmin(int staffId, String token, String name, String email, String handphone, int id) throws UnsupportedEncodingException, IOException {
    ...
    public HashMap<Integer, WebUser> retrieveNormalWorkshopStaff(int staffId, String token, int wsId) throws UnsupportedEncodingException, IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            WebUser staff = new WebUser(indivStaffId, email, userType, refStaffId, indivToken, shopId, name, handphone);
